...
R.register_route_multi_method('/fcv-cdn/sendfile/f/{file}', { 'GET', 'HEAD' }, R.make_route_opts_anon(), function(
route_vars
)
...
R.register_route_multi_method('/fcv-cdn/sendfile/t/{file}', { 'GET', 'HEAD' }, R.make_route_opts_anon(), function(
route_vars
)
    local id = file_model.extract_name_and_extension(route_vars.file)
