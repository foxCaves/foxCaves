<div class="container well well-small">
	...
	%>
		You currently have a <span class="badge badge-info badge-pro">Pro</span> account valid until <%= G.os.date("%d.%m.%Y %H:%M", pro_expiry) %><% if not HIDE_GOPRO_LINKS then %> <a href="/gopro">Extend pro</a><% end %>
	<% else %>
