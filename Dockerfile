...
RUN git clone --depth 1 --branch v1.0.0 https://github.com/foxCaveslua-resty-auto-ssl.git /tmp/lua-resty-auto-ssl && cp -r /tmp/lua-resty-auto-ssl/lib/* /usr/local/share/lua/5.1/ && rm -rf /tmp/lua-resty-auto-ssl
