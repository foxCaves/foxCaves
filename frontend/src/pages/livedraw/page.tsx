...
export const LiveDrawPage: React.FC = () => {
    ...
    const downloadImage = useCallback(() => {
        (this as unknown as HTMLAnchorElement).href = getCanvas().toDataURL('image/png');
    }, [getCanvas]);
    ...
    return (<>
        ...
        <div id="live-draw-options">
            <fieldset>
                ...
                <br />
                <span>0</span>
                <input id="brush-width-slider" type="range" value="10" min="1" max="9999" step="0.1" onChange={selectBrushWidth} />
                <span id="brush-width-slider-max">9999</span><br />
            ...
            <fieldset>
                ...
                <a download="livedraw-edited.png" onClick={downloadImage}>Download</a>
            </fieldset>
        </div>
    </>);
};
