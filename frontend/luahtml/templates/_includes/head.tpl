...
<html>
	<head>
		...
		<script type="text/javascript" src="/api/v1/config/client.js"></script>
		<script type="text/javascript">if(CONFIG.sentry_dsn){Sentry.init({dsn:CONFIG.sentry_dsn,release:'<%= VERSION %>'});}</script>
