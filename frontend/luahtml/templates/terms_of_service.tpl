		...
		<div class="span12">
			<section id="definitions">
				...
				<ol>
					...
					<li>"foxCaves Network" refers to any website, product, or service owned and/or operated under the foxcav.es or f0x.es domains</li>
			...
			<section id="cma-disclaimer">
				...
				<ul>
					<li>Forging any TCP/IP packet header or any part of the header information in any posting, or in any way using the foxCaves Network to send altered, deceptive, or false source-identifying information</li>
					<li>Interfering with any of the foxCaves Network to cause loss of availability or connectivity</li>
					<li>Attempt unauthorised access to any server on the foxCaves Network</li>
				</ul>
			</section>
			<section id="liability">
				...
				<p>
					foxCaves makes no guarantee of availability for the foxCaves Network and reserves the right to change, withdraw, suspend or discontinue any feature at any time.
					In no event shall foxCaves be liable for any damages, including, without limitation, direct, indirect, incidental, special, consequential, or punitive damages arising out of the use of or inability to use the foxCaves Network or any content thereon.
